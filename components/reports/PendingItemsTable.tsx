      ...
      <div className="flex flex-col gap-6">
        ...
        {data.length > 0 && (
          <div className="grid gap-4 sm:grid-cols-3">
            <Card className="relative overflow-hidden border-0 bg-[#0f0f14] border border-[rgba(245,158,11,0.3)] text-white shadow-lg shadow-[rgba(245,158,11,0.1)]">
            ...
            <Card className="relative overflow-hidden border-0 bg-[#0f0f14] border border-[rgba(249,115,22,0.3)] text-white shadow-lg shadow-[rgba(249,115,22,0.1)]">
              <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -mr-16 -mt-16" />
              <CardContent className="p-6 relative">
                  ...
                  {data.length === 0 ? (
                    ...
                    data.map((row, idx) => (
                      <TableRow key={idx} className="hover:bg-muted/50">
                        ...
                        <TableCell className="text-right font-bold text-[#f59e0b]">{row.pendingQty}</TableCell>
                        <TableCell>
