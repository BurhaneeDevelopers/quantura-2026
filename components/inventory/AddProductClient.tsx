...
export function AddProductClient() {
  ...
  const handleSubmit = (values: ProductFormValues) => {
    addProduct({ ...values, isActive: true, imageUrl: undefined } as Parameters<typeof addProduct>[0]);
  ...
  return (
    <div className="flex flex-col gap-6 p-6">
      <div className="flex items-center gap-4">
        ...
        <PageHeader title="Add New Product" subtitle="Create a new product in your inventory" />
      </div>

      <Card>
        <CardContent className="p-6">
          <Formik initialValues={emptyProduct} validationSchema={productSchema} onSubmit={handleSubmit}>
            {({ setFieldValue, values, isSubmitting }) => (
              <Form className="grid gap-6">
                ...
                <SectionGroup label="Pricing & Tax">
