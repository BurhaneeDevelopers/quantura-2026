...
const steps = [
  {
    id: 1,
    title: "Welcome to Quantura",
    subtitle: "Your AI-Powered Business Management Suite",
    description:
      "Let's take you on a quick journey to show you how Quantura will transform your business operations.",
    icon: Sparkles,
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4 bg-[#050508]">
        ...
        >
          ...
          >
            Your journey with Quantura begins now. Start managing your
            business smarter, not harder.
          </motion.p>
      ...
      <div className="w-full max-w-6xl">
        ...
        <div className="mb-8">
          ...
          <div className="h-2 bg-[rgba(255,255,255,0.08)] rounded-full overflow-hidden">
            <motion.div
              className="h-full bg-gradient-to-r from-[#00c8ff] to-[#a855f7]"
              initial={{ width: 0 }}
        ...
        <motion.div
          ...
          transition={{ duration: 0.3 }}
        >
          <Card className="p-8 md:p-12 shadow-2xl border-0 bg-[#0f0f14] border border-[rgba(255,255,255,0.08)]">
