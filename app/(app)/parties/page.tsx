            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <Card className="card-hover border-l-4 border-l-pink-500">
                <CardContent className="p-4 flex items-center gap-3">
                  <div className="rounded-xl bg-[rgba(236,72,153,0.1)] p-2.5">
              ...
              <Card className={`card-hover border-l-4 ${tab === "customer" ? "border-l-emerald-500" : "border-l-amber-500"}`}>
                <CardContent className="p-4 flex items-center gap-3">
                  <div className={`rounded-xl p-2.5 ${tab === "customer" ? "bg-[rgba(34,197,94,0.1)]" : "bg-[rgba(245,158,11,0.1)]"}`}>
                    <Phone className={`h-5 w-5 ${tab === "customer" ? "text-[#22c55e]" : "text-[#f59e0b]"}`} />
                  </div>
                  <div>
                    <p className="text-xs text-muted-foreground uppercase tracking-wider">
                      {tab === "customer" ? "Total Receivable" : "Total Payable"}
                    </p>
                    <p className={`text-xl font-bold mt-1 ${tab === "customer" ? "text-[#22c55e]" : "text-[#f59e0b]"}`}>
              ...
              <Card className="card-hover border-l-4 border-l-indigo-500">
                <CardContent className="p-4 flex items-center gap-3">
                  <div className="rounded-xl bg-[rgba(99,102,241,0.1)] p-2.5">
