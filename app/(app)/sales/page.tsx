          ...
          <Card className="card-hover border-l-4 border-l-emerald-500">
            <CardContent className="p-4 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold mt-1 text-[#22c55e]">{formatCurrency(totalReceived)}</p>
              </div>
            </CardContent>
          </Card>
          <Card className="card-hover border-l-4 border-l-amber-500">
            <CardContent className="p-4 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold mt-1 text-[#f59e0b]">{formatCurrency(totalPending)}</p>
              </div>
            </CardContent>
          </Card>
        </div>
